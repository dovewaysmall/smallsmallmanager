...
@section('title', 'Payouts This Year')
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Payouts This Year</h4>
...
function loadPayouts() {
    ...
    console.log('Loading payouts from:', '{{ route("payouts.this-year.load") }}');
    
    fetch('{{ route("payouts.this-year.load") }}', {
        method: 'POST',
        headers: {
            ...
            <tr>
                <td colspan="8" class="text-center py-5">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <p class="mb-0 text-muted">No payouts found this year</p>
                    </div>
                </td>
            </tr>
        `;
