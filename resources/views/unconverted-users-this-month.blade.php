...
@section('title', 'Unconverted Users This Month')
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Unconverted Users This Month</h4>
...
function loadUnconvertedUsers() {
    ...
    fetch('{{ route("unconverted-users.this-month.load") }}', {
        method: 'POST',
        headers: {
