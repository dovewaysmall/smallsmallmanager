          ...
          <div class="sidebarmenu">
            <div class="brand-logo d-flex align-items-center nav-logo">
              <a href="../main/index.html" class="text-nowrap logo-img">
                <img src="{{ asset('assets/images/logos/rentsmallsmall-logo-blue.png')}}" alt="Logo" />
              </a>
        ...
        <div class="with-vertical">
          ...
          <nav class="navbar navbar-expand-lg p-0">
            ...
            <div class="d-block d-lg-none py-9 py-xl-0">
              <img src="{{ asset('assets/images/logos/rentsmallsmall-logo-blue.png')}}" alt="matdash-img" />
            </div>
          ...
          <div class="offcanvas offcanvas-start pt-0" data-bs-scroll="true" tabindex="-1" id="mobilenavbar" aria-labelledby="offcanvasWithBothOptionsLabel">
            <nav class="sidebar-nav scroll-sidebar">
              <div class="offcanvas-header justify-content-between">
                <a href="../main/index.html" class="text-nowrap logo-img">
                  <img src="{{ asset('assets/images/logos/rentsmallsmall-logo-blue.png')}}" alt="Logo" /> <img src="../assets/images/logos/logo-icon.svg" alt="Logo" />
                </a>
            ...
            <ul class="navbar-nav align-items-center">
              ...
              <li class="nav-item d-none d-xl-flex align-items-center">
                <a href="../main/index.html" class="text-nowrap nav-link">
                  <img src="{{ asset('assets/images/logos/rentsmallsmall-logo-blue.png')}}" alt="matdash-img" /> <img src="{{ asset('assets/images/logos/rentsmallsmall-logo-blue.png')}}" alt="matdash-img" />
                </a>
              </li>
                  ...
                  <div class="dropdown-menu dropdown-menu-nav dropdown-menu-animate-up py-0 overflow-hidden" aria-labelledby="drop2">
                    <div class="position-relative">
                      <div class="row">
                        ...
                        <div class="col-4 d-none d-lg-flex">
                          <img src="{{ asset('assets/images/backgrounds/mega-dd-bg.jpg')}}" srcset="{{ asset('assets/images/backgrounds/mega-dd-bg.jpg')}}" alt="mega-dd" class="img-fluid mega-dd-bg" />
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  ...
                  <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="../main/frontend-blogdetailpage.html" aria-expanded="false">
                      <span class="rounded-3">
                        <i class="ti ti-circle"></i>
                      </span>
                  ...
                  <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="../main/frontend-portfoliopage.html" aria-expanded="false">
                      <span class="rounded-3">
                        <i class="ti ti-circle"></i>
                      </span>
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  ...
                  <li class="sidebar-item">
                    <a href="{{ asset('main/chart-apex-pie.html')}}" class="sidebar-link">
                      <i class="ti ti-circle"></i>
                      <span class="hide-menu">Pie Chart</span>
                    </a>
                  </li>
                  <li class="sidebar-item">
                    <a href="{{ asset('main/chart-apex-radial.html')}}" class="sidebar-link">
                      <i class="ti ti-circle"></i>
                      <span class="hide-menu">Radial Chart</span>
                    </a>
                  </li>
                  <li class="sidebar-item">
                    <a href="{{ asset('main/chart-apex-radar.html')}}" class="sidebar-link">
                      <i class="ti ti-circle"></i>
                      <span class="hide-menu">Radar Chart</span>
                    </a>
                  </li>
