...
@section('title', 'Repairs This Month')
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Repairs This Month</h4>
...
function loadRepairs() {
    ...
    console.log('Loading repairs from:', '{{ route("repairs.this-month.load") }}');
    console.log('CSRF token:', csrfToken.getAttribute('content'));
    
    fetch('{{ route("repairs.this-month.load") }}', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            ...
            <tr>
                <td colspan="10" class="text-center py-5">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <p class="mb-0 text-muted">No repairs found this month</p>
                    </div>
                </td>
            </tr>
        `;
