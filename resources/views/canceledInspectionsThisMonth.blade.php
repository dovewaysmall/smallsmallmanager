@extends('appcx')
@section('content')
@section('title', 'Canceled Inspections This Month')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Canceled Inspections ({{date('M')}})</h4>
                    <span>
                        <a href="{{url('/canceled-inspections-last-month')}}" class="btn btn-warning btn-xxs shadow">Last Month</a>
                    ...
                    <div class="table-responsive">
                        <table class="table shadow-hover display responsive nowrap" id="datatable" width="100%">
                            ...
                            <tbody>
                                ...
                                @foreach ($canceledInspectionsThisMonth as $inspection)
