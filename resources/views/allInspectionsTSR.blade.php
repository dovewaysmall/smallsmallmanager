        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Inspections TSR</h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table shadow-hover display responsive nowrap" id="datatable" width="100%">
                            ...
                            <tbody>
                                ...
                                @endphp --}}
                                @foreach ($allInspectionsTSR as $inspection)
                                {{-- @php
                                    dd($inspection)
                                @endphp --}}
                                    @if($inspection['assigned_tsr'] == (Auth::user()->parent_id))
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ URL::to('pending-inspection/'.$inspection['id']) }}" class="btn btn-danger btn-xxs shadow">Did not show up</a>
                                                @endif
                                            </td>
                                            <td>
