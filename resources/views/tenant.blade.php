                ...
                <div class="profile-head">
                    ...
                    <div class="profile-info">
                        ...
                        <div class="profile-details">
                            ...
                            @foreach($singleTenant as $singleTenantone)
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-7 col-xxl-12 mt-3">
                            ...
                            <a href="#nogo" class="btn btn-primary btn-md mb-2">Account Manager: @if($account_manager =='')
                                Not Assigned
                            @else
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="d-flex mr-3 align-items-center">
                        ...
                        <h4 class="fs-20 text-black mb-0">Inspection</h4>
                    </div>
                    <div class="dropdown">
                        ...
                        <table class="table shadow-hover display responsive nowrap" id="datatable" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th><span class="font-w600 text-black fs-16">Inspection Type</span></th>
                                    <th><span class="font-w600 text-black fs-16">Property Name</span></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($tenant as $tenant_single)
                                <tr>
                                    <td>
                                        {{-- <p class="text-black mb-1 font-w600">Sunday</p> --}}
                                        <span class="fs-14">{{date('d-m-Y',strtotime($tenant_single['inspectionDate']))}}</span>
                                    </td>
                                    
                                    <td>
                                        {{-- <p class="text-black mb-1 font-w600">14,2 Km</p> --}}
                                        <span class="fs-14">{{$tenant_single['inspectionType']}}</span>
                                    </td>
                                    <td>
                                        {{-- <p class="text-black mb-1 font-w600">00:53:22”</p> --}}
                                        <span class="fs-14">{{$tenant_single['propertyTitle']}}</span>
                                    </td>
                                </tr>
                                @endforeach
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table shadow-hover">
                            <thead>
                                <tr>
                                    <th><span class="font-w600 text-black fs-16">Move in Date</span></th>
                                    <th><span class="font-w600 text-black fs-16">Booked As</span></th>
                                    <th><span class="font-w600 text-black fs-16">Next Rental</span></th>
                                    <th><span class="font-w600 text-black fs-16">Rental Expiration</span></th>
                                </tr>
                            </thead>
                            <tbody>
                                @if($tenantRentalInfo != '')
                                @foreach ($tenantRentalInfo as $tenantRentalInfo_single)
                                <tr>
                                    <td>
                                        {{-- <p class="text-black mb-1 font-w600">Sunday</p> --}}
                                        <span class="fs-14">{{date('d-m-Y',strtotime($tenantRentalInfo_single['move_in_date']))}}</span>
                                    </td>
                                    <td>
                                        {{-- <p class="text-black mb-1 font-w600">14,2 Km</p> --}}
                                        <span class="fs-14">{{$tenantRentalInfo_single['booked_as']}}</span>
                                    </td>
                                    <td>
                                        {{-- <p class="text-black mb-1 font-w600">00:53:22”</p> --}}
                                        <span class="fs-14">{{date('d-m-Y',strtotime($tenantRentalInfo_single['next_rental']))}}</span>
                                    </td>
                                    <td>
                                        {{-- <p class="text-black mb-1 font-w600">00:53:22”</p> --}}
                                        <span class="fs-14">{{date('d-m-Y',strtotime($tenantRentalInfo_single['rent_expiration']))}}</span>
                                    </td>
                                </tr>
                                @endforeach
                                @else 
