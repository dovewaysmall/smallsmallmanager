				...
				<ul class="metismenu" id="menu">
					...
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Account Managers</span>
						</a>
						<ul aria-expanded="false">
							{{-- <li><a href="{{url('/add-tenant')}}">Add Tenant</a></li> --}}
							<li><a href="{{url('/all-account-managers')}}">All Account Managers</a></li>
					...
					<li>
						...
						<ul aria-expanded="false">
							...
							<li><a href="{{url('/completed-inspections')}}">Completed Inspections</a></li>
							<li><a href="{{url('/canceled-inspections')}}">Canceled Inspections</a></li>
							<li><a href="{{url('/assigned-inspections')}}">Assigned Inspections</a></li>
							{{-- <li><a href="{{url('/inspections-this-month')}}">Inspections(This Month)</a></li> --}}
						</ul>
					</li>
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					...
					@if(Auth::user()->id == '6' || Auth::user()->id == '17' || Auth::user()->id == '14')
					<!--Frances-->
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Staysmallsmall Bookings</span>
						</a>
						<ul aria-expanded="false">
							<li><a href="{{url('/all-stay-bookings')}}">All Bookings</a></li>
							{{-- <li><a href="{{url('/completed-inspections')}}">Completed Inspections</a></li> --}}
							{{-- <li><a href="{{url('/canceled-inspections')}}">Canceled Inspections</a></li> --}}
						</ul>
					</li>
					...
					@if($role == '2')
						<li>
							<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
								<i class="flaticon-381-networking"></i>
								<span class="nav-text">Buysmallsmall Inspections</span>
							</a>
							<ul aria-expanded="false">
								<li><a href="{{url('/all-buy-inspections')}}">All Inspections</a></li>
								{{-- <li><a href="{{url('/completed-inspections')}}">Completed Inspections</a></li> --}}
								{{-- <li><a href="{{url('/canceled-inspections')}}">Canceled Inspections</a></li> --}}
							</ul>
						</li>
					...
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">My Inspections</span>
						</a>
						<ul aria-expanded="false">
							<li><a href="{{url('/all-pending-inspections-tsr')}}">Pending Inspections</a></li>
							<li><a href="{{url('/all-canceled-inspections-tsr')}}">Canceled Inspections</a></li>
							<li><a href="{{url('/all-rescheduled-inspections-tsr')}}">Rescheduled Inspections</a></li>
							<li><a href="{{url('/all-completed-inspections-tsr')}}">Completed Inspections</a></li>
							<li><a href="{{url('/all-inspections-tsr')}}">All Inspections</a></li>
						</ul>
					</li>
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
