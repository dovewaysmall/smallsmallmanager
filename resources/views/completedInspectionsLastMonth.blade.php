@extends('appcx')
@section('content')
@section('title', 'Completed Inspections Last Month')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Completed Inspections Last Month</h4>
                    <span>
                    ...
                    <div class="table-responsive">
                        <table class="table shadow-hover display responsive nowrap" id="datatable" width="100%">
                            ...
                            <tbody>
                                ...
                                @foreach ($completedInspectionsLastMonth as $inspection)
