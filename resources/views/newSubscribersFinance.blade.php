        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">New Subscribers</h4>
                    <span>
...
$api_url = 'https://api.smallsmall.com/staging/api/new-tenants-api';
    ...
    //    }
       ...
       $id = $item['id'];
        echo "<tr>
                ...
                if($today > $item['next_rental']){
                    echo "<td><a href='#' class='btn btn-danger btn-xxs shadow'>Payment Overdue</a></td>";
                }elseif($today < $item['next_rental']){
                    echo "<td><a href='#' class='btn btn-warning btn-xxs shadow'>Payment Not Due</a></td>";
                }
               echo "<td><a href='new-subscribers-finance-update/$id' class='btn btn-primary btn-xxs shadow'>Update</a></td>";
