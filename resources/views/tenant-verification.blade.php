@extends('appcx')
@section('content')
@section('title', 'Tenant Verification')
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="d-flex mr-3 align-items-center">
                        ...
                        <h4 class="fs-20 text-black mb-0">Update Verification</h4>
                    </div>
                    {{-- <div class="dropdown">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form method="post" action="https://api.smallsmall.com/api/update-verification-status-api/">
                            @method('PUT')
                            @csrf
                            ...
                            @endif
                            {{-- {{dd($singleTenantVerifications)}} --}}
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" class="form-control input-rounded" value="{{($singleTenantVerifications[0]['firstName']).' '.($singleTenantVerifications[0]['lastName'])}}" >
                            </div>
                            {{-- <div class="form-group">
                                <label>Property ID</label>
                                <input type="text" value="{{($singleTenantVerifications[0]['lastName'])}}" class="form-control input-rounded" >
                            </div> --}}
                            
                            <div class="form-group">
                                <label>Updated Verification Status</label>   
                                <select class="form-control default-select" id="sel1" name="verified">
                                    <option value="{{($singleTenantVerifications[0]['verified'])}}">
                                        @if($singleTenantVerifications[0]['verified'] == 'no')
                                         Not Verified
                                        @elseif($singleTenantVerifications[0]['verified'] == 'yes')
                                        Verified
                                        @elseif($singleTenantVerifications[0]['verified'] == 'received')
                                        Received
                                        @elseif($singleTenantVerifications[0]['verified'] == 'processing')
                                        Processing 
                                        @else
                                        @endif
                                    </option>
                                ...
                                <input type="hidden" name="id" value="{{($singleTenantVerifications[0]['veriID'])}}" class="form-control input-rounded">
                                <input type="hidden" name="userID" value="{{($singleTenantVerifications[0]['userID'])}}" class="form-control input-rounded">
                            </div>

                            <button type="submit" class="btn btn-primary">Update Vefication</button>
                        </form>
                    </div>
                </div>
