@extends('appcx')
@section('content')
@section('title', 'All Pending Inspections TSR')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">My Pending Inspections TSR</h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table shadow-hover display responsive nowrap" id="datatable" width="100%">
                            ...
                            <tbody>
                                ...
                                @endphp --}}
                                @foreach ($allPendingInspectionsTSR as $inspection)
                                {{-- @php
                                    dd($inspection)
                                @endphp --}}
                                    @if(($inspection['assigned_tsr'] == (Auth::user()->parent_id)) && ($inspection['inspection_status'] == 'pending-assigned'))
                                        <tr>
