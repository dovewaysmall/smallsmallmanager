...
@section('title', 'Payouts This Month')
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Payouts This Month</h4>
...
function loadPayouts() {
    ...
    console.log('Loading payouts from:', '{{ route("payouts.this-month.load") }}');
    
    fetch('{{ route("payouts.this-month.load") }}', {
        method: 'POST',
        headers: {
            ...
            <tr>
                <td colspan="8" class="text-center py-5">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <p class="mb-0 text-muted">No payouts found this month</p>
                    </div>
                </td>
            </tr>
        `;
