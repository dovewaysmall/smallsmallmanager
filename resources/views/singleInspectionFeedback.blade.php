                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-7 col-xxl-12 mt-3">
                            <a href="#" class="btn btn-outline-primary btn-md mb-2">May 28th, 2020<i class="las la-calendar ml-3 scale5"></i></a>
                            ...
                            <a href="#nogo" class="btn btn-outline-primary mr-3 btn-md  mb-2">June 28th, 2020<i class="las la-calendar ml-3 scale5"></i></a>
                            <a href="#nogo" class="btn btn-primary btn-md mb-2">Generate Report<i class="las la-angle-right ml-3 scale5"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="d-flex mr-3 align-items-center">
                        ...
                        <h4 class="fs-20 text-black mb-0">Update Inspection</h4>
                    </div>
                    {{-- <div class="dropdown">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form method="post" action="https://api.smallsmall.com/api/update-post-inspection-feedback-api/">
                            @method('PUT')
                            @csrf
                            ...
                            @endif
                            {{-- {{dd($singleInspectionFeedback)}} --}}
                            <div class="form-group">
                                <label>Inspection ID</label>
                                <input type="text" class="form-control input-rounded" value="{{($singleInspectionFeedback[0]['inspectionID'])}}" >
                            </div>
                            {{-- <div class="form-group">
                                <label>Property ID</label>
                                <input type="text" value="{{($singleInspectionFeedback[0]['propertyID'])}}" class="form-control input-rounded" >
                            </div> --}}
                            <div class="form-group">
                                <label>Property</label>
                                <input type="text" name="propertyTitle" value="{{($singleInspectionFeedback[0]['propertyTitle'])}}" class="form-control input-rounded" readonly >
                            </div>
                            <div class="form-group">
                                <label>Inspection Date</label>
                                <input type="text" value="{{($singleInspectionFeedback[0]['inspectionDate'])}}" class="form-control input-rounded" >
                            </div>
                            <div class="form-group">
                                <label>Updated Inspection Date</label>
                                @if($singleInspectionFeedback[0]['updated_inspection_date'] == '0000-00-00 00:00:00' || $singleInspectionFeedback[0]['updated_inspection_date'] == '' || $singleInspectionFeedback[0]['updated_inspection_date'] == 'NULL')
                                <input type="datetime-local" name="updated_inspection_date" class="form-control input-rounded">
                                @else
                                <input name="updated_inspection_date" value="{{($singleInspectionFeedback[0]['updated_inspection_date'])}}" class="form-control input-rounded">
                                @endif   
                                
                                <div class="form-group">
                                    <label>Inspection Status</label>
                                    <select class="form-control default-select" id="sel1" name="inspection_status">
                                ...
                                <div class="form-group">
                                    <label>Subscriber Inspection Feedback</label>
                                    <select class="form-control default-select" id="sel1" name="customer_inspec_feedback">
                                        <option value="{{($singleInspectionFeedback[0]['customer_inspec_feedback'])}}">{{($singleInspectionFeedback[0]['customer_inspec_feedback'])}}</option>
                                        <option value="Post Inspection Mail Sent">Post Inspection Mail Sent</option>
                                        <option value="Post Inspection Call Made">Post Inspection Call Made</option>
                                    </select>
                                </div>
                                <div class="form-group"> 
                                    <label>CX Feedback Details</label>
                                    <textarea name="cx_feedback_details" class="form-control" rows="6">{{($singleInspectionFeedback[0]['cx_feedback_details'])}}</textarea>
                                </div>

                                {{-- <input type="datetime-local" name="updated_inspection_date" value="{{($singleInspectionFeedback[0]['updated_inspection_date'])}}" class="form-control input-rounded"> --}}
                                <input type="hidden" name="id" value="{{($singleInspectionFeedback[0]['id'])}}" class="form-control input-rounded">
                                <input type="hidden" name="userID" value="{{($singleInspectionFeedback[0]['userID'])}}" class="form-control input-rounded">
                            </div>
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="d-flex mr-3 align-items-center">
                        ...
                        <h4 class="fs-20 text-black mb-0">Rent Information</h4>
                    </div>
                    <div class="dropdown">
                        <button type="button" class="btn btn-primary light btn-md" data-toggle="dropdown" aria-expanded="false">
                            Newest
