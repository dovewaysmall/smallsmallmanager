@extends('appcx')
@section('content')
@section('title', 'Single Buysmallsmall Inspection')
                ...
                <div class="profile-head">
                    ...
                    <div class="profile-info">
                        ...
                        <div class="profile-details">
                            ...
                            @foreach($singleBuyInspection as $singleTenantone)
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table shadow-hover">
                            ...
                            <tbody>
                                {{-- {{dd($singleBuyInspection)}} --}}
                                @foreach ($singleBuyInspection as $tenantRentalInfo_single)
                                <tr>
                                    <td>
                                        {{-- <p class="text-black mb-1 font-w600">Sunday</p> --}}
                                        <span class="fs-14">{{date('d-m-Y',strtotime($tenantRentalInfo_single['date_of_entry']))}}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <span class="fs-14"><a href="{{url('https://buy.smallsmall.com/property/'.$tenantRentalInfo_single['propertyID'])}}" target="_blank" style="color: black !important">{{$tenantRentalInfo_single['property_name']}}</a></span>
                                    </td>
                                    <td>
                                        {{-- <p class="text-black mb-1 font-w600">00:53:22”</p> --}}
                                        <a href="#" class="btn btn-primary btn-xxs shadow">{{$tenantRentalInfo_single['status']}}</a>
                                    </td>
                                </tr>
                                @endforeach
                                {{-- @else  --}}
                            ...
                            <thead>
                                <tr>
                                    <th><span class="font-w600 text-black fs-16">Inspection Date</span></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        {{-- <p class="text-black mb-1 font-w600">Sunday</p> --}}
                                        <span class="fs-14">{{date('d-m-Y',strtotime($tenantRentalInfo_single['inspection_date']))}}</span>
                                    </td>
