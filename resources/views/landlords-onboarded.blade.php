...
@section('title', 'Onboarded Landlords')
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Onboarded Landlords</h4>
                  <nav aria-label="breadcrumb" class="ms-auto">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item" aria-current="page">
                        <span class="badge fw-medium fs-2 bg-success-subtle text-success">
                          Onboarded
                        </span>
                      </li>
                    </ol>
                ...
                <div class="row">
                    <div class="col-md-4 col-xl-3">
                        <form class="position-relative">
                            <input type="text" class="form-control product-search ps-5" id="searchInput" placeholder="Search Onboarded Landlords..." disabled />
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    <div class="d-flex flex-column align-items-center" id="loadingState">
                                        ...
                                        <p class="mb-0 text-muted">Loading onboarded landlords...</p>
                                    </div>
...
function loadLandlords() {
    ...
    fetch('{{ route("landlords.onboarded.load") }}', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            showError(data.error || 'Failed to load onboarded landlords');
        }
    })
    .catch(error => {
        ...
        showError('An error occurred while loading onboarded landlords');
    });
}
...
function renderLandlords() {
            ...
            <tr>
                <td colspan="8" class="text-center py-5">
                    <div class="d-flex flex-column align-items-center">
                        <iconify-icon icon="solar:user-check-line-duotone" class="fs-8 text-success mb-2"></iconify-icon>
                        <p class="mb-0 text-muted">No onboarded landlords found</p>
                    </div>
                </td>
            </tr>
        `;
    ...
    currentPageLandlords.forEach((landlord, index) => {
        ...
        const landlordStatus = landlord.landlord_status || 'active';
        ...
        let landlordStatusClass = 'bg-success';
        switch(landlordStatus) {
            ...
            case 'unboarded':
                ...
                break;
            default:
                landlordStatusDisplay = landlordStatus ? landlordStatus : 'Onboarded';
                landlordStatusClass = 'bg-success';
        }
