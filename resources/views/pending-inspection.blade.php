            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form method="post" action="https://api.smallsmall.com/api/update-inspection-status-api/">
                            @method('PUT')
                            @csrf
                            ...
                            @endif
                            {{-- {{dd($singlePendingInspection)}} --}}
                            <div class="form-group">
                                <label>Inspection ID</label>
                                <input type="text" class="form-control input-rounded" value="{{($singlePendingInspection[0]['inspectionID'])}}" readonly >
                            </div>
                            <div class="form-group">
                                <label>Property ID</label>
                                <input type="text" name="propertyID" value="{{($singlePendingInspection[0]['propertyID'])}}" class="form-control input-rounded" readonly >
                            </div>
                            <div class="form-group">
                                <label>Property</label>
                                <input type="text" name="propertyTitle" value="{{($singlePendingInspection[0]['propertyTitle'])}}" class="form-control input-rounded" readonly >
                            </div>
                            <div class="form-group">
                                <label>Inspection Date</label>
                                <input type="text" value="{{($singlePendingInspection[0]['inspectionDate'])}}" class="form-control input-rounded" >
                                <input type="hidden" name="firstName" value="{{($singlePendingInspection[0]['firstName'])}}" class="form-control input-rounded" >
                                <input type="hidden" name="lastName" value="{{($singlePendingInspection[0]['lastName'])}}" class="form-control input-rounded" >
                            </div>
                            <div class="form-group">
                                <label>Updated Inspection Date</label>
                                @if($singlePendingInspection[0]['updated_inspection_date'] == '0000-00-00 00:00:00' || $singlePendingInspection[0]['updated_inspection_date'] == '' || $singlePendingInspection[0]['updated_inspection_date'] == 'NULL')
                                <input type="datetime-local" name="updated_inspection_date" class="form-control input-rounded">
                                @else
                                <input name="updated_inspection_date" value="{{($singlePendingInspection[0]['updated_inspection_date'])}}" class="form-control input-rounded">
                                @endif   
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control default-select" id="sel1" name="inspection_status">
                                        ...
                                        <option value="apartment-not-available">Apartment Not Available</option>
                                        <option value="multiple-bookings">Multiple Bookings</option>
                                        <option value="did-not-show-up">Did not show up</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Remarks</label>
                                    <select class="form-control default-select" id="sel1" name="inspection_remarks">
                                ...
                                {{-- <input type="datetime-local" name="updated_inspection_date" value="{{($singlePendingInspection[0]['updated_inspection_date'])}}" class="form-control input-rounded"> --}}
                                <input type="hidden" name="id" value="{{($singlePendingInspection[0]['id'])}}" class="form-control input-rounded">
                                <input type="hidden" name="userID" value="{{($singlePendingInspection[0]['userID'])}}" class="form-control input-rounded">
                            </div>
