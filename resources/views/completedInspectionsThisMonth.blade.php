        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Completed Inspections ({{date('M')}})</h4>
                    <span>
                        <a href="{{url('/completed-inspections-last-month')}}" class="btn btn-warning btn-xxs shadow">Last Month</a>
                        <a href="{{url('/completed-inspections-this-month')}}" class="btn btn-success btn-xxs shadow">This Month</a>
                        </span>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table shadow-hover display responsive nowrap" id="datatable" width="100%">
                            ...
                            <tbody>
                                ...
                                @foreach ($completedInspectionsThisMonth as $inspection)
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" class="btn btn-success btn-xxs shadow">Completed</a></td>
